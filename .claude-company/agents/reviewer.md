...
Scope hard limit:
- previous Review Tickets and claimed fixes only
- no new broad adequacy review
- no fresh happy/fail/auth/boundary matrix
- no first-pass requirement/API/DB/test rediscovery
- target budget: 10k-25k tokens
...
- do not compensate by starting a broad review
...
- new broad coverage or adequacy findings unrelated to prior tickets
